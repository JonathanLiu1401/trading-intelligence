...
QUERY_GROUPS = [
    ...
    # --- AI financing / balance-sheet stress (recall-first) ---
    "AI capex debt financing balance sheet",
    "data center lease obligations hyperscaler",
    "AI infrastructure private credit financing",
    "AI data center SPV joint venture financing",
    "cloud compute purchase commitments OpenAI",
    "hyperscaler capital expenditure free cash flow",
    "AI boom credit risk data centers",
    "data center debt issuance refinancing risk",
    "AI infrastructure bubble recession risk",
    "Big Tech capex guidance cut AI",
    "Nvidia customers financing data center orders",
    "Oracle cloud debt AI data center",
    "CoreWeave debt financing GPU cloud",
    "AI startup compute spend cash burn",
    "private credit data center lending",
    "power grid data center financing utility",
    "commercial real estate data center lending",
    "credit spreads AI infrastructure",
    "technology stocks balance sheet obligations",
    "Nasdaq selloff AI capex bubble",
